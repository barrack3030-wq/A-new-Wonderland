...
const defaultIdText = [
  ...
  'Keindahan alam di sini sangat menakjubkan. Pengunjung dapat menikmati suasana yang tenang dan berbagai aktivitas luar ruangan. Tempat ini sangat cocok bagi Anda yang mencari ketenangan dari hiruk-pikuk kota.'
];
  ...
  for (const lang of langs) {
    ...
    for (const file of files) {
      ...
      if (destinationsData[slug] && destinationsData[slug][lang]) {
        ...
        // It could be in any language but since I checked, the placeholder is EXACTLY "### Menikmati Keindahan Alam" and the same ID paragraph in all files.
